...
- [Configuração dos hosts](docs/hosts.md): firewall, hardening do SSH e Fail2Ban.
- [Gestão dos nós K3s](docs/k3s.md): arquitetura, instalação, Gateway API, NetworkPolicy, acesso, backup e atualização.
- [Ferramentas de linha de comando](docs/command-line-tools.md): kubectl, Helm, Argo CD CLI e longhornctl.
- [Serviços básicos](docs/core-services.md): cert-manager, Longhorn, Argo CD e Infisical.
- [Templates copiáveis](docs/templates.md): estrutura GitOps e componentes opcionais.
- [Checklist operacional](docs/operational-checklist.md): verificações antes de concluir a instalação.
