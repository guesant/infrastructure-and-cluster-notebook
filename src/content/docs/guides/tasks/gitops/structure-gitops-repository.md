...
description: Como preparar o diretório gitops/ com o padrão App-of-Apps do Argo CD, copiando os templates, ajustando a URL do repositório e removendo as Applications não utilizadas.
sidebar:
  order: 4
---
...
- [Argo CD: Especificação de `Application`](https://argo-cd.readthedocs.io/en/stable/user-guide/application-specification/): referência dos campos usados para origem, destino e política de sincronização.
